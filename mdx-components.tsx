...
export function useMDXComponents(components: MDXComponents): MDXComponents {
	return {
		...components,
		h1: (props: any) => <h1 className="mt-10 mb-4 text-2xl font-bold" {...props} />,
		h2: (props: any) => <h2 className="mt-8 mb-3 text-xl font-semibold" {...props} />,
		h3: (props: any) => <h3 className="mt-6 mb-2 text-lg font-medium" {...props} />,
		p: (props: any) => <p className="mt-3 text-base text-muted-fg leading-relaxed" {...props} />,
