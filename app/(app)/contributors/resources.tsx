...
import { IconBook, IconBrandGithub, IconBrandX, IconBug, IconChainLink, IconColorPalette, IconComputer } from "justd-icons"
import Image from "next/image"
import { Avatar, buttonStyles, Card, Link, Tooltip } from "ui"
          ...
          <div className="relative" key={frontmatter.fileName}>
            ...
            <Card className="inset-ring inset-ring-fg/10 inset-shadow-fg/10 inset-shadow-xs border-0 bg-bg dark:inset-ring-fg/5 dark:bg-secondary/30">
              ...
              <Card.Footer className="flex flex-wrap gap-1">
                {frontmatter.role && frontmatter.role.length > 0 && frontmatter.role.map((roleItem: string, index: number) => (
